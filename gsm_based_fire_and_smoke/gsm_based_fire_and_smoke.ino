...
const int SensorPin1 = A0; //LM35 sensor pin
const int SensorPin2 = A1;  //smoke sensor pin
...
void loop()
{
  ...
  for (unsigned long start = millis(); millis() - start < 1000;)
  {
    ...
    if (tempC_1 >= 50 || smkC_1 >= 50) 
    {
      ...
      lcd.clear();
      lcd.setCursor(0, 0);
      lcd.print((String)"Temp = " + tempC_1);
      lcd.setCursor(0, 1);
      lcd.print((String)"Smoke Temp = " + smkC_1);
      lcd.clear();
      delay(200);
      ...
      delay(200);
      Serial.println((String)"Temperature = " + tempC_1);
      Serial.println((String)"Smoke Temperature = " + smkC_1);
      delay(200);
